...
<!-- Please read the https://github.com/linuxserver/docker-duplicati/blob/development/.github/CONTRIBUTING.md -->
...
Simply pulling `ghcr.io/linuxserver/duplicati` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
* image version number
  * `docker inspect -f '{{ index .Config.Labels "build_version" }}' ghcr.io/linuxserver/duplicati`
...
* Update the image: `docker pull ghcr.io/linuxserver/duplicati`
...
docker build \
  --no-cache \
  --pull \
  -t ghcr.io/linuxserver/duplicati:latest .
```
